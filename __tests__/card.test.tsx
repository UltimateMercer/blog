...
describe('Card Component', () => {
  it('renders with default props', () => {
    ...
    expect(screen.getByText('The Future of AI: Advancements and Challenges')).toBeDefined();
    ...
    expect(screen.getByAltText('The Future of AI: Advancements and Challenges')).toBeDefined();
